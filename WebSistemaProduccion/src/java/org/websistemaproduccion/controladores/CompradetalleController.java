...
import org.websistemaproduccion.dao.CompradetalleFacade;
...
@ManagedBean(name = "compradetalleController")
@SessionScoped
public class CompradetalleController implements Serializable {
    ...
    @EJB
    private org.websistemaproduccion.dao.CompradetalleFacade ejbFacade;
